...
(function e(t, n, r) {
  function s(o, u) {
    ...
    }).call(this, require("rH1JPG"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_3615f2b.js", "/");
        ...
        Theme = {
          ...
          init: function init() {
            ...
            $(".field-target").change(function () {
              if ($(this).val() == "direct") $(".custom-recipient").show();else $(".custom-recipient").hide();
            });
          }
        };
